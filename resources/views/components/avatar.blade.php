...
<div
    ...
    @if($src)
        <img @class(['shrink-0 w-full h-full object-cover rounded-full']) src="{{ $src }}" alt=""/>
    @else
        <svg class="shrink-0 w-full h-full text-gray-300 bg-gray-100 dark:bg-gray-600" fill="currentColor"
             viewBox="0 0 24 24">
            <path
